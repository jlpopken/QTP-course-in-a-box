...
You can see all the objects associated with your test on the left hand side when you click on the available keywords tab. To open the object repository you click on the . 
